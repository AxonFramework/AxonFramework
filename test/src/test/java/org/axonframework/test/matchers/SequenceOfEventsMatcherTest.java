...
public class SequenceOfEventsMatcherTest {
    ...
    void setUp() {
        ...
        stubEvent4 = new StubEvent();
        stubEvent5 = new StubEvent();
    ...
    void testMatch_FullMatch() {
        ...
        verify(mockMatcher1, never()).matches(stubEvent4);
        verify(mockMatcher1, never()).matches(stubEvent5);
        ...
        verify(mockMatcher2, never()).matches(stubEvent4);
        verify(mockMatcher2, never()).matches(stubEvent5);
        ...
        verify(mockMatcher3, never()).matches(stubEvent4);
        verify(mockMatcher3, never()).matches(stubEvent5);
    }
    ...
    void testMatch_FullMatchWithGaps() {
        ...
        verify(mockMatcher2, never()).matches(stubEvent1);
        verify(mockMatcher2).matches(stubEvent2);
        verify(mockMatcher2).matches(stubEvent3);
        verify(mockMatcher2).matches(stubEvent4);
        verify(mockMatcher2).matches(stubEvent5);

        verify(mockMatcher3, never()).matches(stubEvent1);
        verify(mockMatcher3, never()).matches(stubEvent2);
        verify(mockMatcher3, never()).matches(stubEvent3);
        verify(mockMatcher3, never()).matches(stubEvent4);
        verify(mockMatcher3, never()).matches(stubEvent5);
    ...
    void testMatch_OnlyOneEventMatches() {
        ...
        verify(mockMatcher2, never()).matches(stubEvent1);
        verify(mockMatcher2, never()).matches(stubEvent2);
        verify(mockMatcher2).matches(null);
        verify(mockMatcher3, never()).matches(stubEvent1);
        verify(mockMatcher3, never()).matches(stubEvent2);
        verify(mockMatcher3).matches(null);
    }
