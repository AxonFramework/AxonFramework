...
/**
 * Avro schema loader loading schemas embedded into Java classes generated by Avro Java Maven generator,
 * which include the original schema in a static field.
 */
public class SpecificRecordBaseClasspathAvroSchemaLoader implements ClasspathAvroSchemaLoader {
    ...
    private static Schema getClassSchema(Class<SpecificRecordBase> clazz) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
