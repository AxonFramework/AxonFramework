...
@ContextConfiguration(classes = MessageHandlingMemberSubscriberDefinitionRegistrarTest.Context.class)
public class MessageHandlingMemberSubscriberDefinitionRegistrarTest {
