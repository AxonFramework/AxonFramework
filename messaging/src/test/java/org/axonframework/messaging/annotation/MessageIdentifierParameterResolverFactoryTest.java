...
class MessageIdentifierParameterResolverFactoryTest {
    ...
    void resolvesToMessageIdentifierWhenAnnotatedForEventMessage() {
        ...
        ProcessingContext processingContext = StubProcessingContext.forMessage(eventMessage);
        assertTrue(resolver.matches(processingContext));
        assertEquals(eventMessage.getIdentifier(), resolver.resolveParameterValue(processingContext));
    }
    ...
    void resolvesToMessageIdentifierWhenAnnotatedForCommandMessage() {
        ...
        ProcessingContext processingContext = StubProcessingContext.forMessage(commandMessage);
        assertTrue(resolver.matches(processingContext));
        assertEquals(commandMessage.getIdentifier(), resolver.resolveParameterValue(processingContext));
    }
