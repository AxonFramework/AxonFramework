...
class SimpleResourceParameterResolverFactoryTest {
    ...
    void resolvesToResourceWhenMessageHandlingMethodHasResourceParameter() {
        ...
        assertEquals(TEST_RESOURCE, resolver.resolveParameterValue(processingContext));
    }
    ...
    void resolvesToResourceWhenMessageHandlingMethodHasAnotherResourceParameter() {
        ...
        assertTrue(resolver.matches(processingContext));
        assertEquals(TEST_RESOURCE2, resolver.resolveParameterValue(processingContext));
    }
