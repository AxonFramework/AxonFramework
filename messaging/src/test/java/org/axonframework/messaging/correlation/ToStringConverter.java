...
/**
 * Simple test implementation of the {@link Converter} expecting {@code String}. Invokes the {@link Object#toString()}
 * method of the value to convert at all times.
 *
...
public class ToStringConverter implements Converter {
    ...
    public boolean canConvert(Class<?> sourceType, Class<?> targetType) {
        return String.class.isAssignableFrom(targetType) || String.class.isAssignableFrom(sourceType);
    }
