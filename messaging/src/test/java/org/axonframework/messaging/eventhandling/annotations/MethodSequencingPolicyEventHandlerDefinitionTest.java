...
class MethodSequencingPolicyEventHandlerDefinitionTest {
    ...
    static class MethodLevelPolicyTest {
        ...
        @EventHandler
        @org.axonframework.messaging.eventhandling.annotations.SequencingPolicy(type = SequentialPolicy.class)
        void sequentialPolicyMethod(String payload) {
        }

        @SuppressWarnings("unused")
        @EventHandler
        @org.axonframework.messaging.eventhandling.annotations.SequencingPolicy(type = MetadataSequencingPolicy.class, parameters = {"userId"})
        void metadataPolicyMethod(TestEvent payload) {
        }

        @SuppressWarnings("unused")
        @EventHandler
        @org.axonframework.messaging.eventhandling.annotations.SequencingPolicy(type = PropertySequencingPolicy.class, parameters = {"aggregateId"})
        void propertyPolicyMethod(TestEvent payload) {
        }

        @SuppressWarnings("unused")
        @EventHandler
        @org.axonframework.messaging.eventhandling.annotations.SequencingPolicy(type = MetadataSequencingPolicy.class, parameters = {"param1", "param2", "param3"})
        void invalidParameterCountMethod(TestEvent payload) {
        }

        @SuppressWarnings("unused")
        @EventHandler
        @org.axonframework.messaging.eventhandling.annotations.SequencingPolicy(type = InvalidClassPositionPolicy.class, parameters = {"someParameter"})
    ...
    static class MethodOverridesClassTest {
        @SuppressWarnings("unused")
        @EventHandler
        @org.axonframework.messaging.eventhandling.annotations.SequencingPolicy(type = MetadataSequencingPolicy.class, parameters = {"override"})
        void eventHandlerMethod(String payload) {
        }
    }
}