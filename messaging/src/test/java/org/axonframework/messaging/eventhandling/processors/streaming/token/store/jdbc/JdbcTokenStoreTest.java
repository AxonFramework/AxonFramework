...
package org.axonframework.messaging.eventhandling.processors.streaming.token.store.jdbc;
...
import org.axonframework.messaging.eventhandling.processors.streaming.token.store.jdbc.GenericTokenTableFactory;
import org.axonframework.messaging.eventhandling.processors.streaming.token.store.jdbc.JdbcTokenEntry;
import org.axonframework.messaging.eventhandling.processors.streaming.token.store.jdbc.JdbcTokenStore;
import org.axonframework.messaging.eventhandling.processors.streaming.token.store.jdbc.JdbcTokenStoreConfiguration;
