...
public abstract class ContextTestSuite<C extends Context> {
    ...
    protected static final ResourceKey<String> TEST_RESOURCE_KEY = ResourceKey.getFor(EXPECTED_RESOURCE_VALUE);
    ...
    void withResourceReturnsNewContextInstanceWithTheExpectedResources() {
        ...
        ResourceKey<String> testResourceKeyTwo = ResourceKey.getFor(expectedResourceValueTwo);
