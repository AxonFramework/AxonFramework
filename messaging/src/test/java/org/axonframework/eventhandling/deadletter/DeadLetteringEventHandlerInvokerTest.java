...
class DeadLetteringEventHandlerInvokerTest {
    ...
    private static final DomainEventMessage<String> TEST_EVENT = org.axonframework.utils.EventTestUtils.createDomainEvent();
    ...
    void handleMethodHandlesEventJustFineWithCacheWhenDlqNotEmptyKeepsTrackNotInDlq() throws Exception {
        ...
        EventMessage<?> eventMessageOne = org.axonframework.utils.EventTestUtils.createDomainEvent("foo", 2);
        EventMessage<?> eventMessageTwo = org.axonframework.utils.EventTestUtils.createDomainEvent("bar", 2);
        EventMessage<?> eventMessageThree = org.axonframework.utils.EventTestUtils.createDomainEvent("foo", 3);
    ...
    void handleMethodHandlesEventJustFineWithCacheWhenDlqNotEmptyAndRespectCacheSize() throws Exception {
        ...
        DomainEventMessage<?> eventMessageOne = org.axonframework.utils.EventTestUtils.createDomainEvent("foo", 2);
        DomainEventMessage<?> eventMessageTwo = org.axonframework.utils.EventTestUtils.createDomainEvent("bar", 2);
    ...
    private static DomainEventMessage<?> nextMessage(DomainEventMessage<?> domainEventMessage) {
        return org.axonframework.utils.EventTestUtils.createDomainEvent(domainEventMessage.getAggregateIdentifier(), domainEventMessage.getSequenceNumber() + 1L);
    }
}
