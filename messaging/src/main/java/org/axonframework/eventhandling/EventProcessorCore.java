...
/**
 * Core implementation for event processors. This class encapsulates the common functionality previously provided by
 * {@link AbstractEventProcessor} to enable composition-based design pattern instead of inheritance.
 *
 * @author [Your Name]
 * @since 5.0
 */
public class EventProcessorCore {
    ...
    /**
     * Instantiate a {@link EventProcessorCore} based on the fields contained in the {@link Builder}.
     * <p>
     ...
     *
     * @param builder the {@link Builder} used to instantiate a {@link EventProcessorCore} instance
     */
    protected EventProcessorCore(Builder builder) {
        builder.validate();
    ...
    /**
     * Register a handler interceptor that is invoked before each event is handled.
     *
     * @param interceptor the interceptor to invoke before each event is handled
     * @return a handle to unregister the interceptor
     */
    ...
    /**
     * Get a list of registered handler interceptors.
     *
     * @return a list of registered handler interceptors
     */
     ...
     */
    public final CompletableFuture<Void> processInUnitOfWork(List<? extends EventMessage<?>> eventMessages,
                                                             UnitOfWork unitOfWork) throws Exception {
        return processInUnitOfWork(eventMessages, unitOfWork, ROOT_SEGMENT);
    }
    ...
    public CompletableFuture<Void> processInUnitOfWork(List<? extends EventMessage<?>> eventMessages,
        ...
        unitOfWork.onInvocation(processingContext -> {
            ...
            for (EventMessage<?> message : eventMessages) {
                result = result.thenCompose(v -> spanFactory
                        .createProcessEventSpan(isStreamingProcessor(), message)
        ...
        return spanFactory.createBatchSpan(isStreamingProcessor(), eventMessages)
    ...
    /**
     * Helper method to determine if this processor is a streaming processor. This is used for creating the correct span
     * types.
     *
     * @return true if this is a streaming processor
     */
    protected boolean isStreamingProcessor() {
        return false;
    }
    ...
    /**
     * Builder class to instantiate a {@link EventProcessorCore}.
     * <p>
    ...
    public static class Builder {
        ...
        /**
         * Builds a new EventProcessorCore instance using the configured properties.
         *
         * @return a new EventProcessorCore instance
         */
        public EventProcessorCore build() {
            return new EventProcessorCore(this);
        }
    }

    /**
     * Creates a new Builder to build an EventProcessorCore.
     *
