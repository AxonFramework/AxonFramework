 ...
 * {@link EventMessage} and registers the {@link MessageMonitor.MonitorCallback} hooks for reporting.
 * Invoked by the {@link org.axonframework.eventhandling.InterceptingEventSink}.
 */
public class MonitoringEventDispatchInterceptor implements MessageDispatchInterceptor<EventMessage> {
    ...
    /**
     * Constructs a new {@link MonitoringEventDispatchInterceptor} using the given {@link MessageMonitor}.
     *
     * @param messageMonitor the message monitor to use for reporting.
     */
    public MonitoringEventDispatchInterceptor(MessageMonitor<? super EventMessage> messageMonitor) {
