 ...
 * @since 3.0
 */
public abstract class LegacyAbstractEventProcessor implements EventProcessor {
    ...
    /**
     * Instantiate a {@link LegacyAbstractEventProcessor} based on the fields contained in the {@link Builder}.
     * <p>
     ...
     *
     * @param builder the {@link Builder} used to instantiate a {@link LegacyAbstractEventProcessor} instance
     */
    protected LegacyAbstractEventProcessor(AbstractEventProcessorBuilder builder) {
        builder.validate();
