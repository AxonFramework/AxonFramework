...
/**
 * Support class containing common {@link EventProcessor} functionality. Before processing of a batch of messages this
 * implementation creates a Unit of Work to process the batch.
 * <p>
 ...
 * @since 5.0.0
 */
public final class EventProcessorOperations implements MessageHandlerInterceptorSupport<EventMessage<?>> {
    ...
    public Registration registerHandlerInterceptor(
        ...
        return () -> interceptors.remove(handlerInterceptor);
    }
    ...
    public CompletableFuture<Void> processInUnitOfWork(List<? extends EventMessage<?>> eventMessages,
        ...
        unitOfWork.onInvocation(processingContext -> {
            ...
            for (EventMessage<?> message : eventMessages) {
                result = result.thenCompose(v -> spanFactory
                        .createProcessEventSpan(streaming, message)
        ...
        return spanFactory.createBatchSpan(streaming, eventMessages)
    ...
    public static class Builder {
        ...
        /**
         * Whether the event processor is a {@link StreamingEventProcessor}.
         *
         * @param streaming Whether the event processor is a {@link StreamingEventProcessor}.
         * @return the current Builder instance, for fluent interfacing
         */
        ...
        private void assertEventProcessorName(String eventProcessorName, String exceptionMessage) {
            assertThat(eventProcessorName, name -> Objects.nonNull(name) && !name.isEmpty(), exceptionMessage);
        }
    }
}
