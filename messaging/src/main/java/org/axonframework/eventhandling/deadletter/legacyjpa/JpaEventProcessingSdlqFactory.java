...
public class JpaEventProcessingSdlqFactory<M extends EventMessage<?>> implements EventProcessingSdlqFactory<M> {
     ...
     * {@link org.axonframework.eventhandling.deadletter.jpa.JpaSequencedDeadLetterQueue}.
     * <p>
     ...
     * to {@code 100}, and the converters default to containing a single
     * {@link org.axonframework.eventhandling.deadletter.jpa.EventMessageDeadLetterJpaConverter}.
     * <p>
     * If you have custom {@link EventMessage} to use with this queue, replace the current (or add a second) converter.
     * <p>
     * The {@link EntityManagerProvider}, {@link TransactionManager} and {@link Serializer}
     * have to be configured for the {@link JpaEventProcessingSdlqFactory}
     * to be constructed.
     *
    ...
    public static class Builder<T extends EventMessage<?>> {
         ...
         * complete. Other invocations of the
         * {@link org.axonframework.eventhandling.deadletter.jpa.JpaSequencedDeadLetterQueue#process(Predicate,
         * Function)} method will be unable to process a sequence while the claim is active. Its default is 30 seconds.
         * <p>
        ...
        /**
         * Initializes a {@link org.axonframework.eventhandling.deadletter.jpa.JpaSequencedDeadLetterQueue} as specified
