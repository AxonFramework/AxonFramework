 ...
 * @since 4.6.0
 * @deprecated in favor of using {@link org.axonframework.eventhandling.deadletter.jpa.EventMessageDeadLetterJpaConverter}
...
public class EventMessageDeadLetterJpaConverter implements DeadLetterJpaConverter<EventMessage<?>> {
    ...
    @Override
    public DeadLetterEventEntry convert(EventMessage<?> message, Serializer eventSerializer,
    ...
    @Override
    public EventMessage<?> convert(DeadLetterEventEntry entry, Serializer eventSerializer,
                                   Serializer genericSerializer) {
