 ...
 * <p>
 * The {@code PooledStreamingEventProcessorsModule} provides a centralized way to configure and register multiple
 * pooled streaming event processors. It acts as a container module that manages individual 
 ...
 * {@link org.axonframework.eventstreaming.StreamableEventSource}, and processor settings that apply to all 
 * processors unless explicitly overridden.
 * <p>
...
public class PooledStreamingEventProcessorsModule extends BaseModule<PooledStreamingEventProcessorsModule> {
     ...
     * {@link org.axonframework.eventhandling.configuration.NewEventProcessingModule}. Users should not instantiate 
     * this class directly but instead access it through 
    ...
    /**
     * Configures default settings that will be applied to all {@link PooledStreamingEventProcessor} instances 
     ...
     * <p>
     * Common use cases include setting default buffer sizes, segment counts, thread pool configurations, or 
     * error handling policies that should apply to all processors unless explicitly overridden.
     *
     * @param configureDefaults A function that receives the Axon configuration and processor configuration, 
     *                         returning a modified {@link PooledStreamingEventProcessorConfiguration} with the 
     *                         desired defaults applied.
     ...
     * managed by this module.
     * <p>
     * This is a simplified version of {@link #defaults(BiFunction)} that provides only the processor configuration
     * for modification, without access to the Axon {@link Configuration}. Use this when your default configurations 
     * don't require components from the application configuration.
     *
     * @param configureDefaults A function that modifies the {@link PooledStreamingEventProcessorConfiguration} 
     *                         with desired defaults.
     * @return This module instance for method chaining.
     */
    public PooledStreamingEventProcessorsModule defaults(
     ...
     * <p>
     * Use this method when you have a fully configured processor module that you want to register directly.
     * The module will inherit the shared defaults configured through {@link #defaults(BiFunction)} or 
     ...
     * <p>
     * This is the simplest way to register a pooled streaming event processor. The processor will be created
     * with default configuration plus any shared defaults configured through {@link #defaults(BiFunction)} or 
     * {@link #defaults(UnaryOperator)} methods.
     *
     * @param name                     The unique name for the event processor.
     * @param eventHandlingComponents The list of {@link EventHandlingComponent} instances that this processor 
     *                               should handle events for.
     * @return This module instance for method chaining.
     */
    ...
    /**
     * Registers a new {@link PooledStreamingEventProcessor} with the given name, event handling components, 
     * and custom configuration.
     * <p>
     * This method allows you to specify processor-specific customizations that will be applied in addition to 
     * any shared defaults. The customization function receives both the Axon {@link Configuration} and the 
     * processor configuration, allowing access to application-wide components.
     *
     * @param name                     The unique name for the event processor.
     * @param eventHandlingComponents The list of {@link EventHandlingComponent} instances that this processor 
     *                               should handle events for.
     ...
     * <p>
     * This method provides the most flexibility for processor configuration. You are responsible for setting
     * all necessary configuration, including event handling components. The customization function receives
     * both the Axon {@link Configuration} and the processor configuration.
     *
     * @param name      The unique name for the event processor.
     * @param customize A function that fully configures the {@link PooledStreamingEventProcessorConfiguration} 
     *                 for this processor.
     * @return This module instance for method chaining.
     */
    public PooledStreamingEventProcessorsModule processor(
