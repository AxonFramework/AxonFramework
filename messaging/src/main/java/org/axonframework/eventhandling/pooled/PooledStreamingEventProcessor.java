 ...
 * @since 4.5
 */
public class PooledStreamingEventProcessor extends AsyncAbstractEventProcessor implements StreamingEventProcessor {
    ...
    protected PooledStreamingEventProcessor(PooledStreamingEventProcessor.Builder builder) {
        ...
        this.coordinator = Coordinator.builder()
                                      ...
                                      .eventFilter(event -> canHandleType(event.type()))
