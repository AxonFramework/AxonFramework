 ...
 * @since 4.13.0
 */
public class JacksonSerializer3 implements Serializer {
    ...
    /**
     * Instantiate a Builder to be able to create a {@link JacksonSerializer3}.
     * <p>
     ...
     * Lastly, if the provided converter is of type ChainingConverter, the {@link JacksonSerializer3#registerConverters}
     * is performed to automatically add the {@link JsonNodeToByteArrayConverter} and {@link ByteArrayToJsonNodeConverter}.
     *
     * @return a Builder to be able to create a {@link JacksonSerializer3}
     */
    ...
    /**
     * Instantiate a {@link JacksonSerializer3} based on the fields contained in the {@link Builder}.
     * <p>
     * If the provided converter is of type ChainingConverter, {@link JacksonSerializer3#registerConverters}
     * is called to automatically add the {@link JsonNodeToByteArrayConverter} and {@link ByteArrayToJsonNodeConverter}.
     *
     * @param builder the {@link Builder} used to instantiate a {@link JacksonSerializer3} instance
     */
    protected JacksonSerializer3(Builder builder) {
        builder.validate();
...
//            System.out.println(">>> " + getWriter().writeValueAsString(object) + "   <----  " + object);

            T serializedContent = converter.convert(serializedBytes, expectedRepresentation);
//
//            if(object != null) {
//                System.out.println("<<< " + objectMapper.readValue((byte[])serializedContent, object.getClass()));
//            }
    ...
    /**
     * Builder class to instantiate a {@link JacksonSerializer3}.
     * <p>
     * The {@link RevisionResolver} is defaulted to an {@link AnnotationRevisionResolver}, the {@link Converter} to a
     * {@link ChainingConverter} and the {@link ClassLoader} to the ClassLoader of {@code this} class.
     * <p>
     * Upon instantiation, the created ObjectMapper will the {@link MetaDataDeserializer} registered to it. Lastly, if
     * the provided converter is of type ChainingConverter, the {@link JacksonSerializer3#registerConverters} is
    ...
    public static class Builder {
         ...
         * @return the current Builder instance, for fluent interfacing
         */
        public Builder jsonMapperBuilderCustomizer(JacksonSerializer3Customizer customizer) {
        ...
        /**
         * Initializes a {@link JacksonSerializer3} as specified through this Builder.
         *
         * @return a {@link JacksonSerializer3} as specified through this Builder
         */
        public JacksonSerializer3 build() {
            return new JacksonSerializer3(this);
        }
