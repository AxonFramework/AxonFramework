 ...
 * capabilities such as default {@link org.axonframework.messaging.SubscribableMessageSource} and processor 
 * settings that apply to all processors unless explicitly overridden.
 * <p>
...
public class SubscribingEventProcessorsModule extends BaseModule<SubscribingEventProcessorsModule> {
    ...
    /**
     * Configures default settings that will be applied to all {@link org.axonframework.eventhandling.SubscribingEventProcessor} 
     * instances managed by this module.
     * <p>
     * This method allows you to specify configurations that should be shared across all subscribing event 
     ...
     *                         returning a modified {@link SubscribingEventProcessorConfiguration} with the 
     ...
     *
     * @param configureDefaults A function that modifies the {@link SubscribingEventProcessorConfiguration} 
    ...
    /**
     * Registers a new {@link org.axonframework.eventhandling.SubscribingEventProcessor} with the given name 
     * and event handling components.
     * <p>
     * This is the simplest way to register a subscribing event processor. The processor will be created
    ...
    /**
     * Registers a new {@link org.axonframework.eventhandling.SubscribingEventProcessor} with the given name, 
     * event handling components, and custom configuration.
     * <p>
     ...
     * @param eventHandlingComponents The list of {@link EventHandlingComponent} instances that this processor 
     *                               should handle events for.
     * @param customize               A function that customizes the {@link SubscribingEventProcessorConfiguration} 
     ...
     *
     * @param name      The unique name for the event processor.
     * @param customize A function that fully configures the {@link SubscribingEventProcessorConfiguration} 
     *                 for this processor.
     * @return This module instance for method chaining.
     */
    public SubscribingEventProcessorsModule processor(
