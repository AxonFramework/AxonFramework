...
public class MultiHandlerEnhancerDefinition implements HandlerEnhancerDefinition {
     ...
     * <p>
     * If one of the delegates is a MultiHandlerEnhancerDefinition itself, that factory's delegates are 'mixed' with the
     * given {@code delegates}, based on their respective order.
     *
