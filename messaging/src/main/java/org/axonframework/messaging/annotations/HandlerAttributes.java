...
public interface HandlerAttributes {
     ...
     * {@link org.axonframework.commandhandling.CommandMessage} to the handler.
     */
    ...
    /**
     * Attribute key referencing the name of the {@link org.axonframework.eventhandling.EventMessage} the handler can
     * handle.
     */
