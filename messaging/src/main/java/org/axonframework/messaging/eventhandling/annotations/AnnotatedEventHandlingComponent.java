...
/**
 * Adapter that turns any {@link org.axonframework.messaging.eventhandling.annotations.EventHandler} annotated bean into a
...
public class AnnotatedEventHandlingComponent<T> implements EventHandlingComponent {
     ...
     *                                 {@link org.axonframework.messaging.eventhandling.annotations.EventHandler} annotated
     *                                 methods.
     ...
     *
     * @param annotatedEventHandler The object containing the
     *                              {@link org.axonframework.messaging.eventhandling.annotations.EventHandler} annotated methods.
     * @param delegate              The delegate event handling component to which the handlers will be subscribed.
