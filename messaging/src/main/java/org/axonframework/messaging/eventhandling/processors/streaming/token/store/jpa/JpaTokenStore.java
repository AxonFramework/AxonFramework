...
package org.axonframework.messaging.eventhandling.processors.streaming.token.store.jpa;
...
import org.axonframework.messaging.eventhandling.processors.streaming.token.store.ConfigToken;
import org.axonframework.messaging.eventhandling.processors.streaming.token.store.TokenStore;
import org.axonframework.messaging.eventhandling.processors.streaming.token.store.UnableToClaimTokenException;
import org.axonframework.messaging.eventhandling.processors.streaming.token.store.UnableToInitializeTokenException;
import org.axonframework.messaging.eventhandling.processors.streaming.token.store.UnableToRetrieveIdentifierException;
...
import static org.axonframework.messaging.eventhandling.processors.streaming.token.store.jpa.TokenEntry.clock;
