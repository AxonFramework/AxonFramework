 ...
 *             pooledStreaming.processor("calendar-processor",
 *                                       components -> components.declarative("weekStarted", cfg -> weekStartedEventHandler))
 *                        .processor("astrologers-week-symbol-processor",
 *                                   components -> components.declarative("weekSymbolProclaimed", cfg -> weekSymbolProclaimedEventHandler)))
 *         .subscribing(subscribing ->
 *             subscribing.processor("creatures-dwelling-readmodel",
 *                                   components -> components.autodetected("dwellingBuilt", cfg -> dwellingBuiltEventHandler)));
 * }</pre>
 *
