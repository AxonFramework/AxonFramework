...
/**
 * Simple implementation of the {@link SubscribingEventProcessor} that {@link EventBus#subscribe(Consumer) subscribes}
 * to the {@link EventBus} for events. Events published on the event bus are supplied to this processor in the
 * publishing thread.
 *
 ...
 * @since 3.0.0
 */
public class SimpleSubscribingEventProcessor implements SubscribingEventProcessor {
    ...
    /**
     * Instantiate a {@code SimpleSubscribingEventProcessor} with given {@code name}, {@code eventHandlingComponents} and
     ...
     *
     * @param name                    A {@link String} defining this {@link SubscribingEventProcessor} instance.
     ...
     *                                {@code SimpleSubscribingEventProcessor} instance.
     */
    public SimpleSubscribingEventProcessor(
            @Nonnull String name,
