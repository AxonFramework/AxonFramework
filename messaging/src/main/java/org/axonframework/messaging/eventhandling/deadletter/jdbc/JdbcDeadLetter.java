...
public class JdbcDeadLetter<E extends EventMessage> implements DeadLetter<E> {
    ...
    public JdbcDeadLetter(String identifier,
                          ...
                          E message) {
        this(identifier, index, sequenceIdentifier, enqueuedAt, lastTouched, cause, diagnostics, message, null);
    }

    /**
     * Constructs a new {@link JdbcDeadLetter} with all possible parameters including a {@link Context}.
     * <p>
