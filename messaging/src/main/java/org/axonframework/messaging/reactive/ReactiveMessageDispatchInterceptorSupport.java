...
/**
 * Interface marking components capable of registering a {@link ReactiveMessageDispatchInterceptor}. Generally, these
 * are messaging
 ...
 * @since 4.4
 */
public interface ReactiveMessageDispatchInterceptorSupport<M extends Message<?>> {

    /**
     * Register the given {@link ReactiveMessageDispatchInterceptor}. After registration, the interceptor will be
     * invoked for each
