 ...
 * {@link ComponentDefinition ComponentDefinitions} with
 * {@link ComponentDefinition#onStart(int, Consumer) start} and/or
 * {@link ComponentDefinition#onShutdown(int, Consumer) shutdown} handlers.
 *
 * @author Steven van Beelen
 * @see ComponentDefinition#onStart(int, Consumer)
 * @see ComponentDefinition#onShutdown(int, Consumer)
 * @since 4.3.0
 */
