...
package org.axonframework.integrationtests.eventsourcing.eventstore.benchmark.mongo;
...
public class MongoEventStoreBenchMark extends AbstractEventStoreBenchmark {
    ...
    protected void prepareForBenchmark() {
        DefaultMongoTemplate mongoTemplate = DefaultMongoTemplate.builder().mongoDatabase(mongoDb).build();
