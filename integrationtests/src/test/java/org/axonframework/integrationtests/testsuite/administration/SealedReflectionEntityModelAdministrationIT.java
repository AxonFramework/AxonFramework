 ...
 */
public class SealedReflectionEntityModelAdministrationIT extends AbstractAdministrationIT {

    @Override
    protected EventSourcingConfigurer testSuiteConfigurer(EventSourcingConfigurer configurer) {
        var personEntity = EventSourcedEntityModule.autodetected(PersonIdentifier.class, SealedPerson.class);
