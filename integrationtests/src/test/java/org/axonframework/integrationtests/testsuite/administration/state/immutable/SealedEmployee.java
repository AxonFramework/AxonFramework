...
public record SealedEmployee(
    ...
    @EntityCreator
    public SealedEmployee(EmployeeCreated employeeCreated) {
    ...
    @EventSourcingHandler
    public SealedEmployee on(TaskAssigned event) {
    ...
    @Override
    public SealedEmployee on(EmailAddressChanged event) {
        return new SealedEmployee(
                identifier,
                event.emailAddress(),
                salaryInformation,
    ...
    public SealedEmployee evolveSalaryInformation(ImmutableSalaryInformation immutableSalaryInformation) {
        return new SealedEmployee(
                identifier,
                emailAddress,
