...
class AvroSchemaStoreAutoConfigurationTest {
                ...
                .run(context -> {
                    ...
                    assertThat(
                            schemaStore.findByFingerprint(
                                    AvroUtil.fingerprint(org.axonframework.extension.springboot.fixture.avro.test2.ComplexObject.getClassSchema())
                            )
                    ).isEqualTo(org.axonframework.extension.springboot.fixture.avro.test2.ComplexObject.getClassSchema());
    ...
    void axonAutoConfigurationConstructsAvroConverterThatIsAbleToSerializeBecauseOfAnnotationScanRegisteredSchema() {
        testApplicationContext
                ...
                .run(context -> {
                    ...
                    org.axonframework.extension.springboot.fixture.avro.test2.ComplexObject deserialized = converter.convert(serialized, org.axonframework.extension.springboot.fixture.avro.test2.ComplexObject.class);
                    ...
                    org.axonframework.extension.springboot.fixture.avro.test2.ComplexObject deserializedAfterUpcasting = converter.convert(
                            genericRecord,
                            org.axonframework.extension.springboot.fixture.avro.test2.ComplexObject.class
                    );
    ...
    @AvroSchemaScan(
            ...
            basePackageClasses = org.axonframework.extension.springboot.fixture.avro.test2.ComplexObject.class
    )
    ...
    private static class ContextWithCustomSchemaStore {
        ...
        static {
            ...
            store.addSchema(org.axonframework.extension.springboot.fixture.avro.test2.ComplexObject.SCHEMA$);
        }
