 ...
 * <p>
 * Binds to the {@code axon.eventhandling.processors.<name>.dlq.*} property namespace. Each processor can
 ...
 * }</pre>
 * <p>
 * When no properties are configured for a processor, {@link #forProcessor(String)} returns defaults
...
public class DeadLetterQueueProcessorProperties {
    ...
    /**
     * Returns the DLQ settings for the given processor name.
     * If no settings are configured for this processor, returns defaults (DLQ disabled, cache size 1024).
     *
    ...
    public static class DlqCache {
        ...
        /**
         * Sets the maximum cache size per segment.
         * Setting this to {@code 0} disables the caching wrapper entirely.
         *
