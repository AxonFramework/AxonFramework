...
import org.axonframework.messaging.core.unitofwork.transaction.jdbc.ConnectionTransactionManager;
...
class SpringTransactionManagerTest {
    ...
    void shouldAttachToProcessingLifecycle(@Captor ArgumentCaptor<Consumer<ProcessingContext>> captor) {
        ...
        assertThat(processingContext.getResource(ConnectionTransactionManager.SUPPLIER_KEY)).isNotNull();
