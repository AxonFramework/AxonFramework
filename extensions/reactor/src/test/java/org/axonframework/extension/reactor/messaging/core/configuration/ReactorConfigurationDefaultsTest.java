...
class ReactorConfigurationDefaultsTest {
    ...
    class Enhance {
        ...
        void registersAllThreeReactiveGateways() {
            ...
            // then
            verify(registry).registerIfNotPresent(eq(ReactiveCommandGateway.class), any(ComponentBuilder.class));
            verify(registry).registerIfNotPresent(eq(ReactiveEventGateway.class), any(ComponentBuilder.class));
            verify(registry).registerIfNotPresent(eq(ReactiveQueryGateway.class), any(ComponentBuilder.class));
        }
    }
