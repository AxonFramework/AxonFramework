...
package org.axonframework.modelling.command.legacyjpa;
 ...
 * @since 0.7
 * @deprecated in favor of using {@link org.axonframework.modelling.command.GenericJpaRepository} which moved to jakarta.
 */
@Deprecated
