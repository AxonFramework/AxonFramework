 ...
 * happens if multiple {@link EntityChildMessagingMetamodel#supportedCommands()} contain the same
 * {@link org.axonframework.messaging.QualifiedName}, as well as both child entities returning true for
 * {@link EntityChildMessagingMetamodel#canHandle(CommandMessage, Object, ProcessingContext)}, indicating that they have an active
