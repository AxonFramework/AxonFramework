...
public interface EntityChildMetamodel<C, P> extends EntityEvolver<P> {
     ...
     */
    MessageStream.@NonNull Single<CommandResultMessage> handle(@NonNull CommandMessage message,
     ...
     */
    static <C, P> SingleEntityChildMetamodel.@NonNull Builder<C, P> single(
     ...
     */
    static <C, P> ListEntityChildMetamodel.@NonNull Builder<C, P> list(
            @NonNull Class<P> parentClass,
            @NonNull EntityMetamodel<C> metamodel) {
