...
/**
 * Implementation of {@link EntityEvolvingComponent} that evolves a given {@code entity} of type {@code E} by searching
 * a specific {@link EntityEvolver} based on the {@link QualifiedName} in the {@link EventMessage#type() event's type}.
 *
...
public class SimpleEntityEvolvingComponent<E> implements EntityEvolvingComponent<E>, DescribableComponent {
    ...
    public E evolve(@Nonnull E entity,
        ...
        QualifiedName eventName = requireNonNull(event, "The event must not be null.").type().qualifiedName();
        ...
        return entityEvolver.evolve(
                ...
                event,
                requireNonNull(context, "The processing context must not be null.")
        );
    }
    ...
    public void describeTo(@Nonnull ComponentDescriptor descriptor) {
        requireNonNull(descriptor, "The component descriptor must not be null.")
                .describeProperty("delegates", Collections.unmodifiableMap(entityEvolvers));
    }
}
