...
/**
 * Contract which defines how to build a PreparedStatement for use on {@link OldJdbcEventStorageEngine#appendEvents(List,
 * Serializer)}
 *
 * @author Lucas Campos
 * @since 4.3
...
public interface AppendEventsStatementBuilder {
    ...
    /**
     * Build a statement to be used at {@link OldJdbcEventStorageEngine#appendEvents(List, Serializer)}
     *
