...
/**
 * Interface describing the actions that can be taken on a Transaction to append one or more events to the event store.
 */
public interface AppendEventTransaction {


    /**
     * Appends an event to be appended to the Event Store to this transaction.
     *
     * @param eventMessage The message to append
     */
