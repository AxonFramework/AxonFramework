...
public class SimpleEventSourcedComponent<E> implements EventSourcedComponent<E>, DescribableComponent {
    ...
    /**
     * Constructs a {@code SimpleEntityEvolvingComponent} that evolves an event sourced entity of type {@code e} through
    ...
    public E evolve(@Nonnull E entity,
        ...
        if (entityEvolver == null) {
            logger.debug(
                    "Returning event sourced entity as is since we could not find an entity evolver for named event [{}].",
                    eventName
            );
            return entity;
        }
