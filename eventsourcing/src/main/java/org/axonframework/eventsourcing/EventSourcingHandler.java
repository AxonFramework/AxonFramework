 ...
 * @since 2.1
 * @deprecated In favor of {@code org.axonframework.eventsourcing.annotation.EventSourcingHandler}, as a preparation of
 * the file move performed in Axon Framework 5.
 */
@EventHandler
@Documented
