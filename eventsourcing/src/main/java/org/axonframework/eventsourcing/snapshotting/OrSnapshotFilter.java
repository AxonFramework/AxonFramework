...
/**
 * A {@link SnapshotFilter} implementation combining two other {@code SnapshotFilter}s through an "OR" operation.
 *
 * @author Steven van Beelen
 * @since 4.4
 */
public class OrSnapshotFilter implements SnapshotFilter {

    private final SnapshotFilter first;
    private final SnapshotFilter second;

    /**
     * Construct a {@link OrSnapshotFilter} based on the given {@code first} and {@code second} {@link SnapshotFilter}
     * instances.
     *
     ...
     */
    public OrSnapshotFilter(SnapshotFilter first, SnapshotFilter second) {
        this.first = first;
        this.second = second;
    }
