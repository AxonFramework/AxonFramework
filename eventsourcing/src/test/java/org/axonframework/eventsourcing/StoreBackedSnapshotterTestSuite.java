...
import org.axonframework.eventsourcing.snapshot.store.SnapshotPolicy;
...
public abstract class StoreBackedSnapshotterTestSuite {
    ...
    /**
     * Creates a {@link SnapshotStore} to test.
     *
     * @param converter the converter that should be used, cannot be {@code null}
     * @return a {@link SnapshotStore}, never {@code null}
     */
    protected abstract SnapshotStore createSnapshotStore(Converter converter);

    /**
     * Allows registration of additional components with the ComponentRegistry in
     * the {@link AxonConfiguration} used by this test suite.
     *
