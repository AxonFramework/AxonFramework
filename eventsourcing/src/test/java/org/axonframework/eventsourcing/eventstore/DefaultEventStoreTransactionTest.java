...
class DefaultEventStoreTransactionTest {
    ...
    class AppendEvent {
        ...
        void sourcingConditionIsMappedToAppendCondition() {
            ...
            StepVerifier.create(MessageStreamUtils.asFlux(afterCommitEvents.get()))
        ...
        void sourceReturnsOnlyCommitedEvents() {
            ...
            StepVerifier.create(MessageStreamUtils.asFlux(beforeCommitEvents.get()))
                        .verifyComplete();
        ...
        private void testCanCommitTag(EventCriteria nonExistingCriteria, EventCriteria existingCriteria,
            ...
            awaitSuccessfulCompletion(uow.executeWithResult(context -> {
                ...
                MessageStreamUtils.asFlux(transaction.source(SourcingCondition.conditionFor(nonExistingCriteria))).blockLast();
                MessageStreamUtils.asFlux(transaction.source(SourcingCondition.conditionFor(existingCriteria))).blockLast();
    ...
    class TransactionRollback {
        ...
        void eventsAreNotAppendedWhenTransactionFails() {
            ...
            StepVerifier.create(MessageStreamUtils.asFlux(eventsAfterRollback.get()))
                        .verifyComplete();
        }
