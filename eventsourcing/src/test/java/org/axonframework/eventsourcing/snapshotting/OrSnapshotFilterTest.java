...
/**
 * Test class validating the {@link OrSnapshotFilter}.
 *
 * @author Steven van Beelen
 */
class OrSnapshotFilterTest {

    @Test
    void testFilterInvokesBothFilterRegardlessOfFalseResult() {
        ...
        OrSnapshotFilter testSubject = new OrSnapshotFilter(first, second);
