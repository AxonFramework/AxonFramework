...
public class XStreamSerializer extends AbstractXStreamSerializer {
     ...
     * {@link InputStreamToXomConverter} to the Converter chain.
     */
    public static class Builder extends AbstractXStreamSerializer.Builder implements SerializerBuilder {
        ...
        public XStreamSerializer build() {
            XStreamSerializer serializer = new XStreamSerializer(this);
            if (beanClassLoader != null)
                serializer.getXStream().setClassLoader(beanClassLoader);
            return serializer;
        }
    }
}
