...
public class RunUpcaster {
    ...
    public static void main(String[] args) throws IOException {
        ...
        JdbcEventStorageEngine storageEngine =
                new JdbcEventStorageEngine(serializer, new EventUpcasterChain(new ToDoItemUpcaster()), null,
    ...
    public static class ToDoItemUpcaster extends SingleEventUpcaster {
        ...
        protected boolean canUpcast(IntermediateEventRepresentation intermediateRepresentation) {
            ...
            return intermediateRepresentation.getOutputType().getName().equals(ToDoItemCreatedEvent.class.getName());
        }
        ...
        protected IntermediateEventRepresentation doUpcast(IntermediateEventRepresentation intermediateRepresentation) {
            ...
            // We want to get the data as a Dom4J document. Axon will automatically convert the serialized form.
            return intermediateRepresentation.upcastPayload(targetType, Document.class, oldDocument -> {
