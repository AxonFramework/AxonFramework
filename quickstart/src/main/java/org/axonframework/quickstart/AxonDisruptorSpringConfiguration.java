...
public class AxonDisruptorSpringConfiguration {
    ...
    @Bean
    public Repository<ToDoItem> disruptorRepository(ParameterResolverFactory parameterResolverFactory) {
        return commandBus().createRepository(new GenericAggregateFactory<>(ToDoItem.class), parameterResolverFactory);
    }
