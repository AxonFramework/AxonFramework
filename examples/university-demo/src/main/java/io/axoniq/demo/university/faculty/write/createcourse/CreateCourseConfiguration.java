...
public class CreateCourseConfiguration {
    ...
    public static EventSourcingConfigurer configure(EventSourcingConfigurer configurer) {
        ...
        var commandHandlingModule = StatefulCommandHandlingModule
                ...
                .entity(stateEntity)
                .commandHandlers()
                .commandHandlingComponent(c -> new AnnotatedCommandHandlingComponent<>(new CreateCourseCommandHandler(),
    ...
    private static MultiParameterResolverFactory parameterResolverFactory(NewConfiguration configuration) {
        return MultiParameterResolverFactory.ordered(List.of(
                ClasspathParameterResolverFactory.forClass(CreateCourseCommandHandler.class),
