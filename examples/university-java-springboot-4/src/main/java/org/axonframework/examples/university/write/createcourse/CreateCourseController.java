...
public class CreateCourseController {
     ...
     * <p>
     * Request body: { "courseId": "course-id-string", "name": "Course Name", "capacity": 30 }
     * <p>
     * Example with curl: curl -X POST http://localhost:8080/api/courses \ -H "Content-Type: application/json" \ -d
     * '{"courseId":"my-course-123","name":"Event Sourcing 101","capacity":25}'
     */
    @PostMapping
