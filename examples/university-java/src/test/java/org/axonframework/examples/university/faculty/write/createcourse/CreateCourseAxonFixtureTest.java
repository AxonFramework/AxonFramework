package org.axonframework.examples.university.faculty.write.createcourse;
...
@Disabled("imported test, failing with: [EntityAlreadyExistsForCreationalCommandHandlerException]")
