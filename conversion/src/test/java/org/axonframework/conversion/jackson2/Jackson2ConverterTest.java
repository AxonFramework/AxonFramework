...
/**
 * Test class validating the {@link Jackson2Converter}.
 *
 * @author Allard Buijze
 * @author Mateusz Nowak
 * @author Steven van Beelen
 */
class Jackson2ConverterTest extends ConverterTestSuite<Jackson2Converter> {
    ...
    @Override
    protected Jackson2Converter buildConverter() {
        return new Jackson2Converter(OBJECT_MAPPER);
    }
    ...
    void convertThrowsConversionExceptionOnIOExceptionFromObjectMapper() throws IOException {
        ...
        Jackson2Converter failingTestSubject = new Jackson2Converter(mockedObjectMapper);
