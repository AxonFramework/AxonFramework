...
/**
 * The AnnotationConfigurationBeanDefinitionParser is responsible for parsing
 * the annotation-configuration element from the Axon namespace. The parser
 * registers {@link BeanDefinition}s for an
 * {@link AnnotationCommandHandlerBeanPostProcessor} and an
 * {@link AnnotationEventListenerBeanPostProcessor}, with optional configuration
 * for an explicit {@link CommandBus}, {@link EventBus} and {@link Executor}
 * instance.
 * 
 * @author Ben Z. Tels
 * 
