...
/**
 * The EventStoreBeanDefinitionParser is responsible for parsing the
 * <code>eventStore</code> element form the Axon namespace. It creates a
 * {@link BeanDefinition} based either on a {@link JpaEventStore} or on a
 * {@link FileSystemEventStore}, depending on the selected configuration.
 * 
 * @author Ben Z. Tels
 * 
 */
