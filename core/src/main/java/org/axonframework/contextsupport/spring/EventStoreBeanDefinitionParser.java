...
public class EventStoreBeanDefinitionParser extends AbstractSingleBeanDefinitionParser implements BeanDefinitionParser {
    ...
    protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
        ...
        if (isFileEventStore(element)) {
            ...
            builder.addPropertyValue("baseDir", element.getAttribute(BASE_DIR_ATTRIBUTE));
        }
    ...
    /**
     * Indicates whether the given element describes a JPA event store.
     *
    ...
    /**
     * Indicates whether the given element describes a FileSystem event store.
     *
     * @param element The {@link Element} being parsed.
     * @return Whether or not the element is requesting a FileSystem event store.
     */
