 ...
 * implementation that provides randomly chosen <code>java.util.UUID</code>s.
 * <p/>
 * To provide your own implementation, create a file called <code>org.axonframework.common.IdentifierFactory</code> in
 * the <code>META-INF/services</code> package. The file must contain the fully qualified class name of the
...
public abstract class IdentifierFactory {
     ...
     * provides randomly chosen <code>java.util.UUID</code>s.
     *
