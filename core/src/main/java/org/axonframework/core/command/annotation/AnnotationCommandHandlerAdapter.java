...
package org.axonframework.core.command.annotation;

import org.axonframework.core.command.CommandBus;
import org.axonframework.core.command.NoHandlerForCommandException;
...
/**
 * Adapter that turns any {@link org.axonframework.core.command.annotation.CommandHandler @CommandHandler} annotated
 * bean into a {@link org.axonframework.core.command.CommandHandler CommandHandler} implementation. Each annotated
 * method is subscribed as a CommandHandler at the {@link CommandBus} for the command type specified by the parameter of
 * that method.
 *
 * @author Allard Buijze
 * @see org.axonframework.core.command.annotation.CommandHandler
 * @since 0.5
 */
public class AnnotationCommandHandlerAdapter extends AbstractHandlerInvoker
        implements org.axonframework.core.command.CommandHandler<Object>, AnnotatedHandlerAdapter {
    ...
    public AnnotationCommandHandlerAdapter(Object target, CommandBus commandBus) {
        super(target, org.axonframework.core.command.annotation.CommandHandler.class);
