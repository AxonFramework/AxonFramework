 ...
 * EntityManager instance. This implementation expects the container to have exactly one PersistenceUnit, or provide
 * a default if no explicit Persistence Unit Name is provided.
 *
