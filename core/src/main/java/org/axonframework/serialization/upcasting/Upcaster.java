...
public interface Upcaster<T> {
     ...
     * <code>true</code>, the {@link #upcast(org.axonframework.serialization.SerializedType)} and {@link
     * #upcast(org.axonframework.serialization.SerializedType)} methods should not be
     ...
     * org.axonframework.serialization.upcasting.ExtendedUpcaster} interface instead.
     *
     * @param serializedType The serialized type to upcast
     * @return the upcast serialized type
     *
     * @see org.axonframework.serialization.upcasting.ExtendedUpcaster#upcast(org.axonframework.serialization.SerializedType,
