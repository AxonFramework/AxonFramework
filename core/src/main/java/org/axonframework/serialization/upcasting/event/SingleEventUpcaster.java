 ...
 */
public abstract class SingleEventUpcaster extends SingleEntryUpcaster<IntermediateEventRepresentation> implements Upcaster<IntermediateEventRepresentation> {
}
