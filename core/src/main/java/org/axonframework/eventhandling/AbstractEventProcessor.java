...
/**
 * Abstract {@code EventProcessor} implementation that keeps track of event processor members ({@link EventListener
...
public abstract class AbstractEventProcessor implements EventProcessor, EventProcessingMonitorSupport {
    ...
    /**
     * This implementation returns the name of the event processor.
     * <p>
     * {@inheritDoc}
     */
    @Override
