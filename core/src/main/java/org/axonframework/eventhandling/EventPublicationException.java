...
/**
 * Exception indicating that publication of an Event has failed. In most circumstances, it is possible to retry the
 * operation.
 */
public class EventPublicationException extends AxonTransientException {
