 ...
 */
public class GenericEventSchemaConfiguration implements EventSchemaConfiguration {
    ...
    public GenericEventSchemaConfiguration() {
        this(builder());
    }

    private GenericEventSchemaConfiguration(Builder builder) {
    ...
    protected static class Builder {
        ...
        public EventSchemaConfiguration build() {
            return new GenericEventSchemaConfiguration(this);
        }
    }
}
