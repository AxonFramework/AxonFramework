 ...
 */
public class RollbackOnAllExceptionsAttributeTest {

    @Test
    public void testAlwaysIndicatesRollback() {
        RollbackOnAllExceptionsConfiguration testSubject = new RollbackOnAllExceptionsConfiguration();
