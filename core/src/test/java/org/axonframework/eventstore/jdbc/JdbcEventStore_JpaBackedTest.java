...
//        domainEventStream = Arrays.asList(new GenericDomainEventMessage<>(type, aggregate1, 0, "Message"),
//                                          new GenericDomainEventMessage<>(type, aggregate1, 1, "Message"),
//                                          new GenericDomainEventMessage<>(type, aggregate1, 2, "Message"),
//                                          new GenericDomainEventMessage<>(type, aggregate1, 3, "Message"),
//                                          new GenericDomainEventMessage<>(type, aggregate1, 4, "Message"),
//                                          new GenericDomainEventMessage<>(type, aggregate1, 5, "Message"),
//                                          new GenericDomainEventMessage<>(type, aggregate1, 6, "Message"),
//                                          new GenericDomainEventMessage<>(type, aggregate1, 7, "Message"),
//                                          new GenericDomainEventMessage<>(type, aggregate1, 8, "Message"),
//                                          new GenericDomainEventMessage<>(type, aggregate1, 9, "Message"));
//
...
//                        new GenericDomainEventMessage<>(type, "a", Instant.now(), "someValue",
...
//                new GenericDomainEventMessage<>(type, aggregate2, 0, new Object(),
...
//        for (int t = 0; t < 110; t++) {
//            domainEvents.add(new GenericDomainEventMessage<>(type, aggregateIdentifier, (long) t,
...
//        }
//        testSubject.appendEvents(domainEvents);
//        testSubject.appendSnapshotEvent(new GenericDomainEventMessage<>(type, aggregateIdentifier, (long) 30,
//                                                                        "Mock contents",
//                                                                        MetaData.emptyInstance()
//        ));
//        entityManager.flush();
...
//        entityManager.flush();
//        entityManager.clear();
//        testSubject.appendSnapshotEvent(new GenericDomainEventMessage<>(type, aggregate1, 9, "snapshot"));
//        entityManager.flush();
//        entityManager.clear();
//        testSubject.appendEvents(new GenericDomainEventMessage<>(type, aggregate1, 10, "post-snapshot"));
//
...
//        final GenericDomainEventMessage eventMessage = new GenericDomainEventMessage<>(type, "test", 0, "test");
...
//        testSubject.appendEvents(asList(new GenericDomainEventMessage<>(type, "123",
//                                                                        0L,
//                                                                        "Mock contents",
//                                                                        MetaData.emptyInstance())));
//        entityManager.flush();
//        entityManager.clear();
//        testSubject.appendEvents(asList(new GenericDomainEventMessage<>(type, "123", 0L,
//                                                                        "Mock contents",
//                                                                        MetaData.emptyInstance())));
//    }
//
...
//                    new GenericDomainEventMessage<>(type, "123", (long) 0, "Mock contents", MetaData.emptyInstance())));
//            entityManager.flush();
//            entityManager.clear();
//            testSubject.appendEvents(asList(new GenericDomainEventMessage<>(type, "123", (long) 0, "Mock contents",
//                                                                            MetaData.emptyInstance())));
...
//
//        testSubject.appendEvents(new GenericDomainEventMessage<>(type, aggregate1, 0, "test"));
//        entityManager.flush();
//        entityManager.clear();
//
//        testSubject.appendSnapshotEvent(new GenericDomainEventMessage<>(type, aggregate1, 0, "snapshot"));
//        entityManager.flush();
//        entityManager.clear();
//
//        testSubject.appendEvents(new GenericDomainEventMessage<>(type, aggregate1, 1, "test"));
//        entityManager.flush();
//        entityManager.clear();
//
//        testSubject.appendSnapshotEvent(new GenericDomainEventMessage<>(type, aggregate1, 1, "snapshot"));
//        entityManager.flush();
//        entityManager.clear();
//
//        @SuppressWarnings({"unchecked"})
...
//                                                "Mock contents", MetaData.emptyInstance()),
//                new GenericDomainEventMessage<>(type, aggregateIdentifier, (long) 4,
//                                                "Mock contents", MetaData.emptyInstance())));
//        testSubject.appendSnapshotEvent(new GenericDomainEventMessage<>(type, aggregateIdentifier,
//                                                                        (long) 3,
//                                                                        "Mock contents",
//                                                                        MetaData.emptyInstance()));
//
