...
//            messages.add(new GenericDomainEventMessage<>(type, aggregateIdentifier, offset + i, new StubStateChangedEvent()));
//        }
//        return  messages;
//    }
//
...
//                new GenericDomainEventMessage<>(type, aggregateId2,
//                                                0,
//                                                new Object(),
...
//        // we store some more events to make sure only correct events are retrieved
//        testSubject.appendEvents(singletonList(
//                new GenericDomainEventMessage<>(type, aggregateId2, 0, new Object(),
...
//        testSubject.appendEvents(domainEventMessages1);
//        testSubject.appendSnapshotEvent(new GenericDomainEventMessage<>(type, aggregateId1, 10, "snapshot"));
...
//        testSubject.appendSnapshotEvent(new GenericDomainEventMessage<>(type, "id1", 1, "test"));
//        try {
//            testSubject.appendSnapshotEvent(new GenericDomainEventMessage<>(type, "id1", 1, "test"));
...
//        testSubject.appendEvents(singletonList(new GenericDomainEventMessage<>(type, "123", 0L, "Mock contents",
//                                                                               MetaData.emptyInstance())));
//        testSubject.appendEvents(singletonList(new GenericDomainEventMessage<>(type, "123", 0L, "Mock contents",
//                                                                               MetaData.emptyInstance())));
//    }
...
//        try {
//            testSubject.appendEvents(singletonList(new GenericDomainEventMessage<>(type, "123", (long) 0, "Mock contents",
//                                                                                   MetaData.emptyInstance())));
//            testSubject.appendEvents(singletonList(new GenericDomainEventMessage<>(type, "123", (long) 0, "Mock contents",
//                                                                                   MetaData.emptyInstance())));
...
//                new GenericDomainEventMessage<>(type, UUID.randomUUID().toString(), (long) 0,
//                                                "Mock contents", MetaData.emptyInstance()),
//                new GenericDomainEventMessage<>(type, UUID.randomUUID().toString(), (long) 0,
//                                                "Mock contents", MetaData.emptyInstance())));
...
//                type, UUID.randomUUID().toString(), 0L, "Mock contents", MetaData.emptyInstance());
...
//            events.add(new GenericDomainEventMessage<>(type, aggregateIdentifier, t,
