...
public class SimpleSagaManagerTest_Asynchronous {
    ...
    public void testAllSagasAreInvoked() {
        ...
        verify(mockTransactionManager, atLeastOnce()).afterTransaction(isA(TransactionStatus.class));
        verify(mockTransactionManager, atLeastOnce()).beforeTransaction(isA(TransactionStatus.class));
    }
