...
//    private final RepositoryProvider repositoryProvider;
    ...
    private final Map<Class<?>, Object> aggregateModels = new ConcurrentHashMap<>();
//    private final Map<Class<?>, AggregateModel<?>> aggregateModels = new ConcurrentHashMap<>();
     ...
     * {@link SpanFactory} is defaulted to a {@link NoOpSpanFactory}.
     *
...
//        }
        ...
        /**
         * Sets the {@link MessageTypeResolver} used to resolve the {@link QualifiedName} for snapshots. If not set, a
         * {@link ClassBasedMessageTypeResolver} is used by default.
         *
         * @param messageTypeResolver The {@link MessageTypeResolver} providing the {@link QualifiedName} for
         *                            snapshots.
         * @return The current Builder instance, for fluent interfacing.
         */
         ...
         * {@link AggregateSnapshotter} type or the first {@code AggregateFactory} it's class as input.
         * <p>
