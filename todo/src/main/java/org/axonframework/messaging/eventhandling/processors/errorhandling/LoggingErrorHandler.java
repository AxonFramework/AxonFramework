...
package org.axonframework.messaging.eventhandling.processors.errorhandling;
...
public class LoggingErrorHandler implements ListenerInvocationErrorHandler {
    ...
    /**
     * Initialize the LoggingErrorHandler using the logger for "org.axonframework.messaging.errorhandling.processors.eventhandling.LoggingErrorHandler".
     */
