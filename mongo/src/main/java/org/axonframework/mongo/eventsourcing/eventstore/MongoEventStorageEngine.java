...
public class MongoEventStorageEngine extends BatchingEventStorageEngine {
     ...
     * @param storageStrategy     The strategy for storing and retrieving events from the collections.
     */
    public MongoEventStorageEngine(Serializer aggregateSerializer, EventUpcaster upcasterChain, Serializer eventSerializer,
                                   MongoTemplate template, StorageStrategy storageStrategy) {
        this(aggregateSerializer, upcasterChain, eventSerializer, null, template, storageStrategy);
    }
     ...
     * @param storageStrategy     The strategy for storing and retrieving events from the collections.
     */
    public MongoEventStorageEngine(Serializer aggregateSerializer, EventUpcaster upcasterChain,
                                   Serializer eventSerializer, Integer batchSize, MongoTemplate template,
                                   StorageStrategy storageStrategy) {
        this(aggregateSerializer, upcasterChain, MongoEventStorageEngine::isDuplicateKeyException,
