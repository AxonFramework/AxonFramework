...
If implementing a custom filter, you must check for the appropriate aggregate type within your filter implementation to ensure that you do not filter our snapshots for other aggregate types.
