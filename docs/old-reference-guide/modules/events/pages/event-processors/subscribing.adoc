...
This will configure persistent streams automatically for all processing groups whith default settings.

You can also override default persistent stream settings

[source,text]
----
axon.axonserver.auto-persistent-streams.batch-size=5
axon.axonserver.auto-persistent-streams.thread-count=10
