...
In combination with Axon's xref:amqp-extension-reference::index.adoc[AMQP] or xref:kafka_extension_guide::index.adoc[Kafka] extension, some of these concerns are alleviated too, making it a viable option.
