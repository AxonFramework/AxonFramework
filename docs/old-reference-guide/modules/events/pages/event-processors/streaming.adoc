...
* several event stores, * link:../../../axon-server/administration/multi-context.md[multiple-contexts], or * from different storage types (for example, an Event Store and a Kafka Stream)
