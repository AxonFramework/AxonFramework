...
The xref:axon-framework-commands:modeling/command-model.adoc[Aggregate] or its xref:axon-framework-commands:modeling/multi-entity-command-models.adoc[Entities] are typically the starting point of all event messages.
...
In the vast majority of cases, the xref:axon-framework-commands:modeling/command-model.adoc[Aggregates] will publish events by applying them.
