...
- Bump the maven-dependencies group with 8 updates link:https://github.com/AxonFramework/AxonFramework/pull/3282[#3282]
- Bump slackapi/slack-github-action from 1.27.0 to 2.0.0 in the github-dependencies group link:https://github.com/AxonFramework/AxonFramework/pull/3281[#3281]
