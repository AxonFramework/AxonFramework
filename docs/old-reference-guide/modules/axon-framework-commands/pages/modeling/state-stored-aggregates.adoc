...
====
Differently from xref:modeling/aggregate.adoc[Event Sourced Aggregates], State-Stored Aggregates can pair the decision making logic and state changes in a Command Handler.
