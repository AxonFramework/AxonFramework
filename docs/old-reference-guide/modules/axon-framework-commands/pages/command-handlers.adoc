...
To make an Aggregate react on events from other Aggregate instances, xref:sagas:index.adoc[Sagas] or xref:events:event-handlers.adoc[Event Handling Components] should be leveraged
