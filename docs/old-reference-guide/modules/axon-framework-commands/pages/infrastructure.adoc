...
Commands should be link:../../architecture-overview/index.adoc#explicit-messaging[routed consistently] to the same application, especially those targeted towards a specific Aggregate.
