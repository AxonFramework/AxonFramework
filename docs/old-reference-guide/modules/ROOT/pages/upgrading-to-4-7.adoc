...
If you have customized the `TokenEntry` or `JdbcTokenEntry`, rebase your changes on the current `TokenEntry`.
This is required since the `JdbcTokenEntry` has been deprecated in favor of the `TokenEntry`.
