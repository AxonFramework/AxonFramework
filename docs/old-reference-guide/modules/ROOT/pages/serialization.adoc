...
Axon Framework uses **Converters** to transform the payload of messages from one format to another (e.g., from Java objects to JSON, or from JSON to byte arrays).
...
== ContentTypeConverters for Upcasting
