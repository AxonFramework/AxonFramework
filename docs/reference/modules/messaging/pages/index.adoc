...
All communications between distinct components is done via messaging. The goal is to ensure location transparency, meaning one component does not need to know where another component is located. Location transparency, in turn, allows developers and operators to scale and distribute these components as necessary.
