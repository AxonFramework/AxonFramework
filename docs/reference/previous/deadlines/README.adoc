...
|​link:deadline-managers.md[Deadline Managers​] |Deadline Handling using Deadline Managers 
|​link:event-schedulers.md[Event Schedulers​] |Deadline Handling using Event Schedulers 
|===