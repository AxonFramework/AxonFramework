...
Suggestions on how to use the `CommandBus` can be found link:command-dispatchers.adoc#_the_command_bus[here].
...
It connects to link:../../axon-server-introduction.md[AxonServer], with which it can send and receive commands.
...
. The link:../../extensions/spring-cloud.md[SpringCloud] extension
. The link:../../extensions/jgroups.md[JGroups] extension
