...
link:command-handlers.adoc#_external_command_handlers[External Command Handlers] however do require direct registration as being a command handler, which is shown in the following sample:
