...
<7> This handler for `StudentUnsubscribed` is a exact opposite of the `evolve` method for `StudentSubscribed` event. We decrease the numbers which we increased in the previous one.
