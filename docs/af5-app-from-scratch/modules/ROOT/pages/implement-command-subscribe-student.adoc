...
But in this case, you load more than needed, and it's more possible to clash with other changes, which cause events that do not influence these certain business rules.
====
