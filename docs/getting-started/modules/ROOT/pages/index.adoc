...
Axon Framework includes several example projects in its repository that demonstrate different patterns, features, and use cases.
Browse the link:https://github.com/AxonFramework/AxonFramework/tree/main/examples[examples directory on GitHub,role=external,window=_blank] to explore these projects and see Axon Framework in action.
====
