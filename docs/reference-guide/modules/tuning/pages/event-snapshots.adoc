...
[WARNING]
.Snapshots not available in Axon Framework 5.0
====
The Snapshots feature is not yet available in Axon Framework 5.0.
It will be reintroduced in Axon Framework 5.1.
The documentation below describes the Snapshots concepts for reference and future use.
====
