...
* **`namespace`**: Defaults to the **package name** of the message class (or the value from a `@Namespace` annotation if present, as described xref:messaging-concepts:anatomy-message.adoc#namespace-annotation[here]).
