...
* **`namespace`**: First checks if the `@Namespace` annotation is present (as described xref:messaging-concepts:anatomy-message.adoc#namespace-annotation[here]). When not present, defaults to the **package name** of the message class.
