...
- full example, not just the list
- list and single entity only, document that map wont work anymore
...
- check instance commandHandler and creational commandHandler
- stateful command handlers
- inject state / nullable to check for existence
