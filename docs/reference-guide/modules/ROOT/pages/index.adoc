...
This reference guide covers Axon Framework 5, which takes a messaging-centric approach to building applications.
...
Axoniq Platform is the platform to monitor and manage your Axon Framework applications. It provides insights into the performance and behavior of your application, and allows you to manage your application's event processors.
