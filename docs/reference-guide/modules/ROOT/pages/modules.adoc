...
|<<Dropwizard metrics>>            |`axon-metrics-dropwizard`         |`org.axonframework.extensions.metrics`  |https://search.maven.org/search?q=a:axon-metrics-dropwizard[available]
|<<Micrometer metrics>>            |`axon-metrics-micrometer`         |`org.axonframework.extensions.metrics`  |https://search.maven.org/search?q=a:axon-metrics-micrometer[available]
