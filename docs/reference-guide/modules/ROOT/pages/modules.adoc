...
|<<Axon Spring>>                        |`axon-spring`                     |`org.axonframework.extensions.spring`   |https://search.maven.org/search?q=a:axon-spring[available]
|<<Axon Spring Boot Starter>>           |`axon-spring-boot-starter`        |`org.axonframework.extensions.spring`   |https://search.maven.org/search?q=a:axon-spring-boot-starter[available]
|<<Axon metrics Dropwizard>>            |`axon-metrics-dropwizard`         |`org.axonframework.extensions.metrics`  |https://search.maven.org/search?q=a:axon-metrics-dropwizard[available]
|<<Axon metrics Micrometer>>            |`axon-metrics-micrometer`         |`org.axonframework.extensions.metrics`  |https://search.maven.org/search?q=a:axon-metrics-micrometer[available]
|<<Axon Tracing OpenTelemetry>>         |`axon-tracing-opentelemetry`      |`org.axonframework.extensions.tracing`  |https://search.maven.org/search?q=a:axon-tracing-opentelemetry[available]
|===
...
This extension provides event store implementations that store event streams in a MongoDB database. https://www.mongodb.com/[MongoDB] is a document-based NoSQL database.
