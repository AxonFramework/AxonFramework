...
Although the description above leans towards event upcasting, note that all the given constructs can be used to upcast a xref:tuning:snapshotting.adoc[snapshot].
...
[WARNING]
====
Whenever constructing a snapshot upcaster, be mindful of xref:tuning:snapshotting.adoc#_filtering_snapshot_events[`SnapshotFilters`].
