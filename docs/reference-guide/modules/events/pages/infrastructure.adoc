...
**Dynamic Consistency Boundaries** (DCB) provide a flexible approach to organizing and querying events.
...
For detailed information on DCB including event tags, EventCriteria, and consistency markers, see xref:event-store-specifics.adoc[Event Storage].
