...
1. <<declarative_config_plain,Declarative configuration>>
2. <<autodetected_config_spring_properties_plain,Autodetected configuration>>, like Spring
...
For a specific Event Processor to be a Subscribing instance using a persistent stream, the <<declarative_config_plain,declarative>> or <<autodetected_config_spring_properties_plain,autodetected>> configuration can be used.
