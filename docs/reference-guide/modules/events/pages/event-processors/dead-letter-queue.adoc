...
=== Getting processors and ProcessingContext
...
You can filter which sequences to process using a predicate.
Note that the predicate filters based on a sequence's _first_ entry:
