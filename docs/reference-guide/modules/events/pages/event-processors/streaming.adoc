...
[source,java]
----
include::example$events/eventprocessors/streaming/declarative/AxonConfig.java[tag=declarative-pooled-streaming-processor,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/streaming/defaults/AxonConfig.java[tag=processor-defaults-with-override,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/streaming/springboot/namespaceselector/EventProcessorConfig.java[tag=event-processor-definition-namespace-selector,indent=0]
----
...
Event Handlers can describe their `@Namespace` on several levels, as described xref:configuration:spring.adoc#namespace-based-handler-selection[here].
...
[source,java]
----
include::example$events/eventprocessors/streaming/springboot/matchingcustomized/EventProcessorConfig.java[tag=event-processor-definition-matching-customized,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/streaming/springboot/matchingdefault/EventProcessorConfig.java[tag=event-processor-definition-matching-default,indent=0]
----
...
[NOTE]
====
In most scenarios, you do not need to invoke `start()` manually.
Axon Framework invokes `start()` automatically as part of its lifecycle management when the application starts up.
Only invoke `start()` directly when you need explicit control over the startup sequence.
====
...
[source,java]
----
include::example$events/eventprocessors/streaming/lifecycle/ProcessorService.java[tag=start-and-query-identifier,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/streaming/initialtoken/AxonConfig.java[tag=initial-token-config-api,indent=0]
----
--
...
[source,java]
----
include::example$events/eventprocessors/streaming/initialtoken/EventProcessorConfig.java[tag=initial-token-spring-boot,indent=0]
----
--
====
...
[source,java]
----
include::example$events/eventprocessors/streaming/tokenclaim/AxonConfig.java[tag=token-claim-config-api,indent=0]
----
--
...
[source,java]
----
include::example$events/eventprocessors/streaming/tokenclaim/EventProcessorConfig.java[tag=token-claim-spring-boot,indent=0]
----
--
====
...
[source,java]
----
include::example$events/eventprocessors/streaming/tokenstore/defaults/AxonConfig.java[tag=token-store-defaults-for-all,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/streaming/tokenstore/specific/AxonConfig.java[tag=token-store-for-specific-processor,indent=0]
----
--
Spring Boot::
+
...
[source,java]
----
include::example$events/eventprocessors/streaming/tokenstore/springboot/AxonConfig.java[tag=token-store-spring-boot-bean,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/streaming/tokenstoreidentifier/AxonConfig.java[tag=token-store-identifier,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/streaming/segmentcount/AxonConfig.java[tag=segment-count-config-api,indent=0]
----
--
...
[source,java]
----
include::example$events/eventprocessors/streaming/segmentcount/EventProcessorConfig.java[tag=segment-count-spring-boot,indent=0]
----
--
...
[source,java]
----
include::example$events/eventprocessors/streaming/sequencingpolicy/onclass/CustomEventHandlingComponent.java[tag=sequencing-policy-on-class,indent=0]
----
--
...
[source,java]
----
include::example$events/eventprocessors/streaming/sequencingpolicy/onhandler/CustomEventHandlingComponent.java[tag=sequencing-policy-on-handler,indent=0]
----
--
====
...
[source,java]
----
include::example$events/eventprocessors/streaming/sequencingpolicy/declarative/AxonConfig.java[tag=declarative-sequencing-policy-config,indent=0]
----
--
...
[source,java]
----
include::example$events/eventprocessors/streaming/sequencingpolicy/springbootbean/AxonConfig.java[tag=sequencing-policy-spring-boot-bean,indent=0]
----
--
====
...
[source,java]
----
include::example$events/eventprocessors/streaming/threadpool/AxonConfig.java[tag=thread-pool-config-api,indent=0]
----
--
...
[source,java]
----
include::example$events/eventprocessors/streaming/threadpool/EventProcessorConfig.java[tag=thread-pool-spring-boot,indent=0]
----
--
...
[source,java]
----
include::example$events/eventprocessors/streaming/segments/release/StreamingProcessorService.java[tag=release-segment,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/streaming/segments/splitmerge/StreamingProcessorService.java[tag=split-merge-segment,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/streaming/replay/resetwithoutcontext/StreamingProcessorService.java[tag=reset-tokens-without-context,indent=0]
----
--
...
[source,java]
----
include::example$events/eventprocessors/streaming/replay/resetwithcontext/StreamingProcessorService.java[tag=reset-tokens-with-context,indent=0]
----
--
====
...
[source,java]
----
include::example$events/eventprocessors/streaming/replay/api/CardSummaryProjection.java[tag=replay-api,indent=0]
----
...
[source,java]
----
include::example$events/eventprocessors/streaming/replay/blocking/AxonConfig.java[tag=replay-blocking-event-handling-component,indent=0]
----
