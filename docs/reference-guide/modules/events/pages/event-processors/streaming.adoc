...
The processor supports all core streaming operations including <<replaying-events,replaying events>>, <<parallel-processing,parallelism>>, and tracking progress with <<tracking_tokens,tokens>>.
...
[source,java]
----
// TODO #3577 - Update once Enhancer API is expanded.
----
--
====
...
public class AxonConfig {
    ...
    @Bean
    public TokenStore myTokenStore(EntityManagerProvider entityManagerProvider,
                                   Converter converter) {
