...
public class AxonConfig {
    ...
    public MultiStreamableEventSource buildMultiStreamableEventSource(
        ...
        return MultiStreamableEventSource.builder()
                                           .addEventSource("eventSourceA", eventSourceA)
                                           .addEventSource("eventSourceB", eventSourceB)
                                           .eventComparator(priorityA) // Where 'priorityA' is a comparator prioritizing events from eventSourceA
                                           .build();
    }
}
----
