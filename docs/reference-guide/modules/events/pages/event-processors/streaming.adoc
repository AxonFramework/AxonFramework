...
Both solutions have examples drafted below, showing how to configure the "my-processor" with a specific event source.
...
The example above shows how to configure "my-processor" as a Pooled Streaming Event Processor.
