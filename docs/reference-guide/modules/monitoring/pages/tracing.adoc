...
====
The Distributed Tracing feature is not yet available in Axon Framework 5.0.
It will be reintroduced in Axon Framework soon.
The documentation below describes the Distributed Tracing concepts for reference and future use.
====
...
ElasticSearch APM, Jaeger, and many other tools are available for collecting and visualizing the information.
