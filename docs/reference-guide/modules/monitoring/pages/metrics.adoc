...
Furthermore, Micrometer offers to option to enable/disable dimensions to your measurements. This allows you to filter the measurements on, for example, the payload type of messages. By default, dimensions are enabled.
