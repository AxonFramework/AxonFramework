...
Finally, we will look at more advanced use cases by expanding the functionality.
As an example, we will model an expiring gift card after a certain amount of time has passed.