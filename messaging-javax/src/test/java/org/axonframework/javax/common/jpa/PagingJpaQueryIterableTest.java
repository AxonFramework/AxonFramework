...
class PagingJpaQueryIterableTest {
    ...
    void queriesJustOneItemAsOnePage() {
        entityManager.persist(new org.axonframework.javax.common.jpa.TestJpaEntry("1"));
    ...
    void queriesMultiplePages() {
        ...
        wantedIds.forEach(item -> {
            entityManager.persist(new org.axonframework.javax.common.jpa.TestJpaEntry(item));
        });
