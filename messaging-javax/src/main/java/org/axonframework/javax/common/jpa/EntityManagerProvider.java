...
public interface EntityManagerProvider {
     ...
     * <p/>
     * Note that the implementation is responsible for keeping track of transaction scope, if necessary. Generally, this
     * is the case when using application-managed EntityManagers.
     *
