...
//                        assertEquals(
//                                "There is no configured repository for org.axonframework.messaging.eventsourcing.SpawningNewAggregateTest$Aggregate2",
//                                cause.getMessage());
//                    } else {
...
//                        assertEquals(
//                                "Since repository provider is not provided, we cannot spawn a new aggregate for org.axonframework.messaging.eventsourcing.SpawningNewAggregateTest$Aggregate2",
//                                cause.getMessage());
//                    } else {
//                        fail("Expected exception");
//                    }
