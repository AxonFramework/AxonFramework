...
public class SequenceEventStorageEngine implements LegacyEventStorageEngine {
    ...
    /**
     * Initializes a new {@link SequenceEventStorageEngine} using given {@code historicStorage} and
     * {@code activeStorage}.
     *
     ...
     *                        will be written
     */
    public SequenceEventStorageEngine(LegacyEventStorageEngine historicStorage,
