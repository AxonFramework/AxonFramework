...
public class CollectionCriteriaTest {
    ...
    public void testValueInCollection() {
        ...
        assertEquals("{ \"prop\" : { \"$in\" : [ \"first\" , \"second\"]}}", actual.asBson().toString());
    }
    ...
    public void testValueInString() {
        ...
        assertEquals("{ \"prop\" : { \"$in\" : \"collection\"}}", actual.asBson().toString());
    }
    ...
    public void testValueNotInCollection() {
        ...
        assertEquals("{ \"prop\" : { \"$nin\" : [ \"first\" , \"second\"]}}", actual.asBson().toString());
    }
    ...
    public void testValueNotInString() {
        ...
        assertEquals("{ \"prop\" : { \"$nin\" : \"collection\"}}", actual.asBson().toString());
    }
