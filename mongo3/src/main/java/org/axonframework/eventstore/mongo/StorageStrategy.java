...
public interface StorageStrategy {
     ...
     */
    List<Document> createDocuments(String type, Serializer eventSerializer, List<DomainEventMessage> messages);
     ...
     */
    List<DomainEventMessage> extractEventMessages(Document entry, Object aggregateIdentifier, Serializer serializer,
     ...
     */
    MongoCursor<Document> findEvents(MongoCollection<Document> collection, String aggregateType, String aggregateIdentifier,
     ...
     */
    MongoCursor findEvents(MongoCollection<Document> collection, MongoCriteria criteria);
     ...
     */
    MongoCursor<Document> findLastSnapshot(MongoCollection<Document> collection, String aggregateType, String aggregateIdentifier);
