...
import org.axonframework.common.mongo.AbstractMongoTemplate;
...
public class DefaultMongoTemplate extends AbstractMongoTemplate implements MongoTemplate {
    ...
    /**
     * Initializes the MongoTemplate using the given <code>mongo</code> for database access, using default database
     ...
     *
     * @param mongoClient The actual connection to a MongoDB instance
     */
     ...
     */
    public DefaultMongoTemplate(MongoClient mongoClient, String databaseName, String domainEventsCollectionName,
