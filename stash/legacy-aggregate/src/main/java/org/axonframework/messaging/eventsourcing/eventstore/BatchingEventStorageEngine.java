...
public abstract class BatchingEventStorageEngine extends AbstractEventStorageEngine {
    ...
    protected BatchingEventStorageEngine(Builder builder) {
        ...
        this.finalAggregateBatchPredicate = getOrDefault(builder.finalAggregateBatchPredicate,
     ...
     * than the given {@code lastToken}. Event entries in the stream should be ordered by tracking token. If the
     * {@code lastToken} is {@code null} a stream containing all events should be returned.
     * <p>
...
//        }
         ...
         */
        public BatchingEventStorageEngine.Builder finalAggregateBatchPredicate(
                Predicate<List<? extends DomainEventData<?>>> finalAggregateBatchPredicate) {
            BuilderUtils.assertNonNull(finalAggregateBatchPredicate,
                                       "The finalAggregateBatchPredicate must not be null");
