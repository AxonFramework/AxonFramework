...
/**
 * Implementation of an {@link Aggregate} that is sourced from events that have been published by the aggregate.
 *
...
//    private final SnapshotTrigger snapshotTrigger;
    ...
    /**
     * Initializes an EventSourcedAggregate instance for the given {@code aggregateRoot}, based on the given
     * {@code inspector}, which publishes events to the given {@code eventBus}.
     *
...
//     * @param snapshotTrigger    The trigger to notify of events and initialization
    ...
    /**
     * Initializes an EventSourcedAggregate instance using the given {@code aggregateFactory}, based on the given
     * {@code inspector}, which publishes events to the given {@code eventBus} and stores events in the given
     * {@code eventStore}.
     *
