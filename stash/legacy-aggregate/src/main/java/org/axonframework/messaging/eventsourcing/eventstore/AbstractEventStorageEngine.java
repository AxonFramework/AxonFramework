...
//        }
         ...
         * {@link Metadata} with.
         *
         * @param eventSerializer The serializer to serialize the Event Message's payload and {@link Metadata} with
         * @return the current Builder instance, for fluent interfacing
         */
         ...
         * specific snapshot revisions which should not be applied. Defaults to {@code SnapshotFilter#allowAll()}.
         * <p>
         * Note that {@code SnapshotFilter} instances can be combined and should return {@code true} if they handle a
         * snapshot they wish to ignore.
         *
         * @param snapshotFilter a {@code SnapshotFilter} which decides whether to take a snapshot into account
         * @return the current Builder instance, for fluent interfacing
         */
