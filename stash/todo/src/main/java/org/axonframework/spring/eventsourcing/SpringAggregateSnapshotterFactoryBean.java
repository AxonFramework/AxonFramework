...
/**
 * Implementation of the {@link AggregateSnapshotter} that eases the configuration when used within a Spring Application
 * Context. It will automatically detect a Transaction Manager and Aggregate Factories.
 *
...
public class SpringAggregateSnapshotterFactoryBean
    ...
    public SpringAggregateSnapshotter getObject() {
        ...
        if (handlerDefinition == null) {
            handlerDefinition = new HandlerDefinitionFactoryBean(new ArrayList<>(BeanFactoryUtils.beansOfTypeIncludingAncestors(
                    applicationContext,
                    HandlerDefinition.class).values()),
                                                                 new ArrayList<>(BeanFactoryUtils.beansOfTypeIncludingAncestors(
                                                                         applicationContext,
                                                                         HandlerEnhancerDefinition.class).values()))
                    .getObject();
        }
