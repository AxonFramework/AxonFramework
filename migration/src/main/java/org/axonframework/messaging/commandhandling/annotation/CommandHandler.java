 ...
 * {@link org.axonframework.commandhandling.AnnotationCommandHandlerAdapter} to subscribe the annotated class to the
 * command bus. This annotation can also be placed directly on Aggregate members to have it handle the commands
 * directly.
 * <p/>
