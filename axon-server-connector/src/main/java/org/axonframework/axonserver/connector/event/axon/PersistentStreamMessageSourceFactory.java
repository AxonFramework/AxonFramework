 ...
 * Implementations should create properly configured {@link PersistentStreamMessageSource} instances
 * that integrate with the Axon Framework 5 async-native API.
 *
 * @author Marc Gathier
 * @since 4.10.0
 */
...
public interface PersistentStreamMessageSourceFactory {
     ...
     *                                   differentiate streams in different environments or applications. May be {@code null}.
