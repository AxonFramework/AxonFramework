...
public class Component<B> {
     ...
     */
    public Component(LegacyConfiguration config, String name,
                     Function<LegacyConfiguration, ? extends B> builderFunction) {
     ...
     * @param builderFunction The builder function of the component
     */
    public Component(@Nonnull Supplier<LegacyConfiguration> config,
                     @Nonnull String name,
                     @Nonnull Function<LegacyConfiguration, ? extends B> builderFunction) {
