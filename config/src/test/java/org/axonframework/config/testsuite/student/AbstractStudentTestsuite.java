...
import org.axonframework.modelling.command.annotation.ModelContainerParameterResolverFactory;
...
public abstract class AbstractStudentTestsuite {
     ...
     * resolve parameters from the classpath, the configuration, the model registry, and the model container.
     */
    protected MultiParameterResolverFactory getParameterResolverFactory() {
        ...
        return new MultiParameterResolverFactory(
                ...
                new ModelContainerParameterResolverFactory(registry)
        );
    }
