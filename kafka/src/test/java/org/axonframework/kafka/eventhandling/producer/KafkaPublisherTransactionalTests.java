 ...
 * @author Nakul Mishra
 */
public class KafkaPublisherTransactionalTests {
    ...
    public void setUp() {
        this.producerFactory = DefaultProducerFactory.<String, byte[]>builder()
                ...
                .withConfirmationMode(TRANSACTIONAL)
                .build();
        this.eventBus = new SimpleEventBus();
        messageConverter = new DefaultKafkaMessageConverter(new XStreamSerializer());
        this.testSubject = new KafkaPublisher<>(publisherConfig(messageConverter, producerFactory));
    ...
    private KafkaPublisherConfiguration<String, byte[]> publisherConfig(DefaultKafkaMessageConverter messageConverter, ProducerFactory<String, byte[]> producerFactory) {
        MessageMonitor<? super EventMessage<?>> mock = mock(MessageMonitor.class);
        return KafkaPublisherConfiguration.<String, byte[]>builder()
                .withProducerFactory(producerFactory)
                .withMessageMonitor(mock)
...
//    public void testCannotActivateTransactionWithTransactionalID() {
...
//    }
    ...
    private static Map<String, Object> senderConfigs(String brokers) {
        ...
        properties.put(ProducerConfig.TRANSACTIONAL_ID_CONFIG, "kafkaPublisherTest.id");
